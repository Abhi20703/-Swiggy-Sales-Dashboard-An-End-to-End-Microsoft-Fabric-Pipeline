...
Built as part of an end-to-end data analytics capstone project demonstrating the Microsoft Fabric ecosystem — from data ingestion through Lakehouse and Data Warehouse to final Power BI visualization.
